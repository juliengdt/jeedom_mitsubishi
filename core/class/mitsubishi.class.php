    ...
    public function postSave()
    {
         ...
         if ($this->getConfiguration('deviceid') != '' && !is_object($RefreshCmd)) {
             ...
             if ($this->getConfiguration('typepac') == 'air/air'){
        		...
        		if (!is_object($RoomTemperature)) {
                    $RoomTemperature = new mitsubishiCmd();
               ...
               if (!is_object($off)) {
                ...
                if (!is_object($ActualFanSpeed)) {
                    $ActualFanSpeed = new mitsubishiCmd();
		...
		$NextCommunication = $this->getCmd(null, 'NextCommunication');
        	if (!is_object($NextCommunication)) {
                  ...
                  $NextCommunication = new mitsubishiCmd();
			   ...
			   if (!is_object($OutdoorTemperature)) {
				   $OutdoorTemperature = new mitsubishiCmd();
			   ...
			   if (!is_object($RoomTemperature2)) {
				   $RoomTemperature2 = new mitsubishiCmd();
			   ...
			   if (!is_object($ForcedHotWaterMode)) {
				   $ForcedHotWaterMode = new mitsubishiCmd();
			   ...
			   if (!is_object($temphotwater)) {
				   $temphotwater = new mitsubishiCmd();
    ...
    public function execute($_options = array())
    {
        ...
        if ('Consigne' ==  $this->name || 'Consigne' == $this->getLogicalId() || 'SetTemperature' == $this->getLogicalId() ) {
            ...
            if (isset($_options['slider'])) {
                mitsubishi::SetModif($_options['slider'], $this->getEqLogic(),'SetTemperature',4);
            }
        }
        ...
        if ('ForcedHotWaterMode' == $this->getLogicalId()) {
          ...
          if ($this->getLastValue() == 0){
            mitsubishi::SetModif('true', $this->getEqLogic(),'ForcedHotWaterMode',65536);
          }else{
            mitsubishi::SetModif('false', $this->getEqLogic(),'ForcedHotWaterMode',65536);
          }
        ...
        if ('SetTemperatureZone1' == $this->getLogicalId()) {
            if (isset($_options['slider'])) {
                mitsubishi::SetModif($_options['slider'], $this->getEqLogic(),'SetTemperatureZone1',8589934592);
            }
        }

      	if ('SetTemperatureZone2' == $this->getLogicalId()) {
            if (isset($_options['slider'])) {
                mitsubishi::SetModif($_options['slider'], $this->getEqLogic(),'SetTemperatureZone2',34359738880);
            }
        }

        if ('On' == $this->getLogicalId()) {
        	mitsubishi::SetModif('true', $this->getEqLogic(),'Power',1);
        }
        if ('Off' == $this->getLogicalId()) {
        	mitsubishi::SetModif('false', $this->getEqLogic(),'Power',1);
        }
        ...
        if ('Ventilation' == $this->name || 'Ventilation' == $this->getLogicalId()) {
            if (isset($_options['slider'])) {
                ...
                mitsubishi::SetModif($newFanSpeed, $this->getEqLogic(),'SetFanSpeed',8);
            }
        }

        if ('ModeAuto' == $this->getLogicalId()) {
        	mitsubishi::SetModif(8, $this->getEqLogic(),'OperationMode',6);
        }
        if ('Ventile' == $this->getLogicalId()) {
        	mitsubishi::SetModif(7, $this->getEqLogic(),'OperationMode',6);
        }
      	if ('Froid' == $this->getLogicalId()) {
        	mitsubishi::SetModif(3, $this->getEqLogic(),'OperationMode',6);
        }
      	if ('Chauffage' == $this->getLogicalId()) {
        	mitsubishi::SetModif(1, $this->getEqLogic(),'OperationMode',6);
        }
        if ('sechage' == $this->getLogicalId()) {
        	mitsubishi::SetModif(2, $this->getEqLogic(),'OperationMode',6);
        }
        if ('Mode' == $this->name || 'Mode' == $this->getLogicalId() || 'OperationMode' == $this->getLogicalId()) {
            if (isset($_options['slider'])) {
                mitsubishi::SetModif($_options['slider'], $this->getEqLogic(),'OperationMode',6);
            }
        }
