...
sendVarToJS('eqType', 'mitsubishi');
$eqLogics = eqLogic::byType('mitsubishi');
  ...
  <div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 25px;">
    ...
    <div class="eqLogicThumbnailContainer">
      ...
      foreach ($eqLogics as $eqLogic) {
        ...
        echo "<center>";
        echo '<img src="plugins/mitsubishi/plugin_info/mitsubishi_icon.png" height="105" width="95" />';
        echo "</center>";
        ...
        <form class="form-horizontal">
          <fieldset>
            <div class="form-group">
              <label class="col-sm-3 control-label">{{Nom du mitsubishi}}</label>
              <div class="col-sm-3">
                <input type="text" class="eqLogicAttr form-control" data-l1key="id" style="display : none;" />
                <input type="text" class="eqLogicAttr form-control" data-l1key="name" placeholder="{{Nom de l'équipement mitsubishi}}"/>
              </div>
            </div>
            <div class="form-group">
