...
?>
    ...
    <div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 25px;">
        ...
        <legend><i class="fa fa-list-alt"></i> {{Mes équipements mitsubishi}}</legend>
        ...
        <div class="eqLogicThumbnailContainer">
            ...
            foreach ($eqLogics as $eqLogic) {
                ...
                echo "<center>";
                echo '<img src="plugins/mitsubishi/doc/images/mitsubishi_appareil_icon.png" height="105" width="95" />';
                echo "</center>";
